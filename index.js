...
/***/ "./src/SuppressSpuriousPermissionError.ts":
/*!************************************************!*\
  !*** ./src/SuppressSpuriousPermissionError.ts ***!
  \************************************************/
/*! exports provided: suppressSpuriousPermissionErrors */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"suppressSpuriousPermissionErrors\", function() { return suppressSpuriousPermissionErrors; });\n\r\n;\r\nfunction suppressSpuriousPermissionErrors() {\r\n    process.on('uncaughtException', handleUncaughtException);\r\n}\r\n;\r\nfunction handleUncaughtException(error) {\r\n    const permissionError = error;\r\n    const isSpurious = 'errno' in permissionError\r\n        &&\r\n            'syscall' in permissionError\r\n        &&\r\n            'code' in permissionError\r\n        &&\r\n            'filename' in permissionError\r\n        &&\r\n            permissionError.errno === -4048\r\n        &&\r\n            permissionError.syscall === 'watch'\r\n        &&\r\n            permissionError.code === 'EPERM'\r\n        &&\r\n            permissionError.filename === null;\r\n    if (isSpurious)\r\n        return;\r\n    console.error(error.stack || error);\r\n    process.exit(1);\r\n}\r\n;\r\n\n\n//# sourceURL=webpack:///./src/SuppressSpuriousPermissionError.ts?");
